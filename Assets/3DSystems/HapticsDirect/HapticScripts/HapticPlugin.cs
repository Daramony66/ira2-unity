...
public class HapticPlugin : MonoBehaviour
{
    ...
    //public Matrix4x4 DeviceTransformRawReal; // Ajouté le 27/03 à 12h55
    ...
    private void FixedUpdate()
    {
        if (DeviceHHD >= 0)
        {
            ...
            //Ajouté me 27/03 à 12h55
            // if (freezeTranslation)
            // {
            //     DeviceTransformRaw = Matrix4x4.identity;
            // }
            //////////////////////////
            ...
            UpdateTransfrom(); //Commenté le 27/03 à 11h16
            ...
            //     CollisionMesh.GetComponent<Rigidbody>().velocity = Vector3.zero;
            // }
            
            //Ajouté le 27/03 à 11h45
            // else
            // {
            //     //Commenté le 27/03 à 13h05
            //     /*transform.position = frozenPosition; // bloquer HapticActor_DefaultDevice
            //     Matrix4x4 newMatrix = transform.localToWorldMatrix * DeviceTransformRaw;
            //     VisualizationMesh.transform.rotation = newMatrix.ExtractRotation();*/ 
            //     CollisionMesh.GetComponent<Rigidbody>().velocity = Vector3.zero;
            // }
    ...
    //Ajouté le 27/03 à 10h00
    // public void SetFrozenPosition(Vector3 pos)
    // {
    //     frozenPosition = pos;
    // }
    ...
    public void GetDeviceTransformationRaw()
    {
        ...
        // DeviceTransformRawReal = DeviceTransformRaw; // stocker avant freeze //Ajouté le 27/03 à 12h55
    ...
    public void UpdateTransfrom()
    {
        ...
        if (transformDirect==true)
        {
            ...
            if (!freezeTranslation)
            {
                VisualizationMesh.transform.position = newMatrix.ExtractPosition();
            }
            else
            {
        ...
        //Ajouté le 27/03 à 10h05 //Commenté le 27/03 à 11h16
        // if (transformDirect == true)
        // {
        //     if (!freezeTranslation)
        //     {
        //         rBody.position = targetPos;
        //         VisualizationMesh.transform.position = newMatrix.ExtractPosition();
        //         frozenPosition = newMatrix.ExtractPosition(); // on mémorise la dernière position
        //     }
        //     else
        //     {
        //         rBody.velocity = Vector3.zero;
        //         //VisualizationMesh.transform.position = frozenPosition; // on force la position mémorisée //Commenté le 27/03 à 10h45
        //         VisualizationMesh.transform.position = CollisionMesh.transform.position; // suit le CollisionMesh //Ajouté le 27/03 à 10h45
        //         transform.position = frozenPosition; // Ajouté le 27/03 à 11h05 //bloquer HapticActor_DefaultDevice
        //     }
        //     rBody.drag = 0;
        //     VisualizationMesh.transform.rotation = newMatrix.ExtractRotation();
        // }
