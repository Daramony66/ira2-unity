...
public class HapticForceLearner_V3 : MonoBehaviour
{
    ...
    void Update()
    {
            ...
            correctionAnchored && expertPlugin != null && expertButtonPressed)
        {
            ...
            float k    = mutuel ? mutualStiffness : correctionStiffness;
            float d    = mutuel ? mutualDamping   : correctionDamping;
            float fmax = mutuel ? mutualMaxForce  : correctionMaxForce;
            ...
            corr -= d * learnerVel; //Ajouté le 21/07
