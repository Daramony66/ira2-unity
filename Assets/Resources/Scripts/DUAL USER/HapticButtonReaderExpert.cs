...
public class HapticButtonReaderExpert : MonoBehaviour
{
    ROSConnection ros;
    ...
    void Start()
    {
        ...
        ros.RegisterPublisher<PoseStampedMsg>("expert/haptic_position");
        ros.RegisterPublisher<Int32Msg>("expert/button_pressed");
        
        ros.RegisterPublisher<BoolMsg>("expert/reset_position"); //ajoutée
    ...
    private void PublishPosition()
    {
        ...
        ros.Publish("expert/haptic_position", colliderPoseStamped);
    ...
    private void ButtonPressed(Int32Msg msg)
    {
        ...
        ros.Publish("expert/button_pressed", new Int32Msg(button_pressed));
    ...
    {
        if (calibration != null && !calibration.teleopActive) return; //Ajouté le 09/07 à 12h45 - ne pas publier la position si la calibration n'est pas terminée
        ...
        // {
        //     ros.Publish("expert/button_pressed", new Int32Msg(0));
        ...
        // {
        //     ros.Publish("expert/reset_position", new BoolMsg(true));
        //     ros.Publish("expert/button_pressed", new Int32Msg(0));
        //     //Debug.Log("HapticButtonReader : Aucun bouton pressé.");
        // }
