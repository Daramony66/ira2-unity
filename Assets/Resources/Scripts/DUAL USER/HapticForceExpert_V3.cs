...
public class HapticForceExpert_V3 : MonoBehaviour
{
    ...
    // Mode "les deux appuient" : couplage mutuel attenue //Ajouté le 21/07
    public float mutualStiffness = 5f;
    public float mutualDamping   = 2f;
    public float mutualMaxForce  = 0.2f;
    ///////////////////////////////////////////////////////////////////////
    ...
    void Update()
    {
        ...
        //Ajouté le 21/07/////////////////////////////////////////////////////////////
        // Actif des que l'apprenant tient : soit il pilote seul (suivi passif),
        // soit les deux tiennent (couplage mutuel attenue).
        if (hapticPlugin != null && hapticPlugin.DeviceHHD >= 0 &&
            learnerPlugin != null && learnerButtonPressed)
        {
            bool mutuel = buttonPressed;
            float k    = mutuel ? mutualStiffness : followStiffness;
            float d    = mutuel ? mutualDamping   : followDamping;
            float fmax = mutuel ? mutualMaxForce  : followMaxForce;
            //////////////////////////////////////////////////////////////////////////
            ...
            if (corr.magnitude > fmax) //Ajouté le 21/07
