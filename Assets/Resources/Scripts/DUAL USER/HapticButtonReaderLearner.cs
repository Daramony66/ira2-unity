...
public class HapticButtonReaderLearner : MonoBehaviour
{
    ROSConnection ros;
    ...
    void Start()
    {
        ...
        ros.RegisterPublisher<PoseStampedMsg>("learner/haptic_position");
        ros.RegisterPublisher<Int32Msg>("learner/button_pressed");
        
        ros.RegisterPublisher<BoolMsg>("learner/reset_position"); //ajoutée
    ...
    private void PublishPosition()
    {
        ...
        ros.Publish("learner/haptic_position", colliderPoseStamped);
    ...
    private void ButtonPressed(Int32Msg msg)
    {
        ...
        ros.Publish("learner/button_pressed", new Int32Msg(button_pressed));
    ...
    private void UpdateButtonStatus()
    {
        ...
        // {
        //     ros.Publish("learner/button_pressed", new Int32Msg(0));
        ...
        // {
        //     ros.Publish("learner/reset_position", new BoolMsg(true));
        //     ros.Publish("learner/button_pressed", new Int32Msg(0));
        //     //Debug.Log("HapticButtonReader : Aucun bouton pressé.");
        // }
